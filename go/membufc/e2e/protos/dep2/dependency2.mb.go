...
func (x *SamePackageDependencyMessage) String() string {
...
func (x *SamePackageDependencyMessage) Equal(y *SamePackageDependencyMessage) bool {
...
func (x *SamePackageDependencyMessage) StringField() string {
